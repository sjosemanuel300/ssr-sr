...
/*
    ...
    THIS TEMPLATE HAS A COUPLE OF FEATURES NOT USED ON THE REGISTER COMPONENT OF BUILDER
    AND SHOULD BE MODIFIED TO YOUR NEEDS
        ...
        return(
            <div className="wizard-container" ref="wizard">
                <Card className="card card-wizard active" data-color="primary">
                    {
                    	(this.props.title !== undefined || this.props.subtitle !== undefined) ?
                    		(
                    			<CardHeader className={this.props.headerTextCenter !== undefined ? "text-center":""} data-background-color={this.state.color}>
                        			{this.props.title !== undefined ?
                        				(<CardTitle tag="h3">{this.props.title}</CardTitle>):null}
                        			{this.props.subtitle !== undefined ?
                        				(<CardSubtitle>{this.props.subtitle}</CardSubtitle>):null}
